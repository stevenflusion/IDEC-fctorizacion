...
export default function ThemeToggle() {
  ...
  const toggle = () => {
    ...
    window.dispatchEvent(
      new CustomEvent("idec-theme-change", { detail: nextTheme }),
    );
  ...
  return (
    <button
      ...
      className="theme-toggle hidden items-center justify-center rounded-xl border border-white/10 bg-white/5 p-2 text-white transition-all duration-300 hover:border-blue-400/30 hover:bg-white/10 lg:flex"
    >
      {isDark ? (
        <svg
